...
import ExitWarning from "../components/Popup/ExitWarning"; // import DesignTemplates from "../pages/designTemplatesPage.jsx";
...
const paths = [
  ...
  { path: "/popup", text: "העלאה באדמין", component: ExitWarning },
];
